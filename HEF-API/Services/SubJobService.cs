...
namespace HEF_API.Services
{
    ...
    {
        public Task<List<SubJob>> GetAllSubJobs(string sortBy = null);
    ...
    public class SubJobService: ServiceBase<SubJob>, ISubJobService
    {
        ...
        public async Task<List<SubJob>> GetAllSubJobs(string sortBy = null) => await GetAll(sortBy).ToListAsync();
