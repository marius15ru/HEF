...
namespace HEF_API.Services
{
    ...
    {
        public Task<List<Comment>> GetAllComments(string sortBy = null);
    ...
    public class CommentService: ServiceBase<Comment>, ICommentService
    {
        ...
        public async Task<List<Comment>> GetAllComments(string sortBy = null) => await GetAll(sortBy).ToListAsync();
