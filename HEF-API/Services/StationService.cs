...
namespace HEF_API.Services
{
    ...
    {
        public Task<List<Station>> GetAllStations(string sortBy = null);
    ...
    public class StationService : ServiceBase<Station>, IStationService
    {
        ...
        public async Task<List<Station>> GetAllStations(string sortBy = null) => await GetAll(sortBy).ToListAsync();
