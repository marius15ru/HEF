...
@Component({
  selector: 'app-user-sub-task-dialog',
  templateUrl: './user-sub-task-dialog.component.html',
  styleUrls: ['./user-sub-task-dialog.component.css']
})
export class UserSubTaskDialogComponent implements OnInit {
